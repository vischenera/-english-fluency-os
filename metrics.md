...
Score once per week using a 60-second recording. Use the same prompt twice per month so progress is visible.

## 1. Fluency Score (0–10)

| Score | Description |
|---:|---|
| 0–2 | Single words or broken phrases only. |
| 3–4 | Can speak, but stops often and restarts. |
| 5–6 | Understandable short answers with pauses. |
| 7–8 | Smooth common-topic speaking with minor pauses. |
| 9–10 | Flexible, natural, and professional under pressure. |

## 2. Hesitation Score

Count silent pauses longer than 2 seconds in a 60-second answer.
