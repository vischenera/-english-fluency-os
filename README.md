...
A Pareto-optimized speaking system for a Malayalam-speaking learner who already understands English and wants maximum practical fluency improvement from **10 minutes per day**.
...
- **Chunks over words:** store multi-word pieces you retrieve whole, not isolated vocabulary.
- **One concept per card:** every card is designed to take under 60 seconds.
- **Retrieval before knowledge:** speak first, then correct.
...
- `roadmap.md` — 8, 12, and 24 week pathways.
- `metrics.md` — fluency, hesitation, grammar, pronunciation, and retrieval scoring.
- `curriculum/frameworks/framework_cards.md` — ~56 sentence-generation frameworks (de-duplicated, each with real examples).
...
- `weekly/weekly_sprints.md` — weekly targets and review rhythm.
- `reviews/review_protocol.md` — spaced repetition (Leitner), recording loop, and AI feedback loop.
- `tracking/progress_tracker.md` — printable / copyable tracker.

## The 10-Minute Daily Loop

1. **1 min — Warm start:** retrieve yesterday's Box 1 cards aloud.
...
By completing the core system, the learner should be able to:

- start and maintain everyday conversations,
...
Start with `daily/10_minute_protocol.md`, follow the 8-week roadmap first, and use `metrics.md` every week. Run the spaced-repetition ladder in `reviews/review_protocol.md` so cards actually become automatic. Do not study more cards because motivation is high — the system works through **consistent short retrieval**, not heroic long sessions.
